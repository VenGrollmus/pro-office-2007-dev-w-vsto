...
#End Region
  ...
  Private Sub TimeRegion_FormRegionShowing(ByVal sender As Object, _
  ...
  'Use Me.OutlookItem to get a reference to the current Outlook item.
  'Use Me.OutlookFormRegion to get a reference to the form region.
  Private Sub TimeRegion_FormRegionClosed(ByVal sender As Object, _
...
#Region "Working With Properties"
  Friend Sub GetPropValues()
    ...
    Try
      ...
      Dim emp As IEmployeeAccountV2 = SBATools.GetEmployeeByGUID( _
        GetUserProperty("TimeEmployee"))

      cboEmployee.SelectedItem = emp

      'Get and Set Project/Job Object
      Dim job As IJobAccountV2 = SBATools.GetJobByGUID( _
        GetUserProperty("TimeJob"))

      cboJob.SelectedItem = job

      'Get and Set BillCode Object
      Dim code As IItemAccount = SBATools.GetBillCodeByGUID( _
        GetUserProperty("TimeBillCode"))
...
#Region "Control Events"
  ...
  Private Sub btnSave_Click(ByVal sender As System.Object, _
    ...
    Dim ts As ITimeSlip
    Dim ai As Outlook.AppointmentItem = _
      DirectCast(Me.OutlookItem, Outlook.AppointmentItem)
